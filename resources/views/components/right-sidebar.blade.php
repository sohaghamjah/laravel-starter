              ...
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="https://wieldy-html.g-axon.work/back-office-mini" target="_blank" class="choose-option__icon">
                    <img src="{{ asset('/assets/images/layouts/no-header-mini-sidebar.png') }}" alt="No Header Mini Sidebar Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="https://wieldy-html.g-axon.work/back-office" target="_blank" class="choose-option__icon">
                    <img src="{{ asset('/assets/images/layouts/vertical-no-header.png') }}" alt="Vertical No Header Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
              ...
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="https://wieldy-html.g-axon.work/horizontal-dark" target="_blank" class="choose-option__icon">
                    <img src="{{ asset('/assets/images/layouts/horizontal-dark.png') }}" alt="Horizontal Dark Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="https://wieldy-html.g-axon.work/horizontal-inside-nav" target="_blank" class="choose-option__icon">
                    <img src="{{ asset('/assets/images/layouts/horizontal-inside-nav.png') }}" alt="Horizontal Inside Nav Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="https://wieldy-html.g-axon.work/horizontal-bottom-nav" target="_blank" class="choose-option__icon">
                    <img src="{{ asset('/assets/images/layouts/horizontal-bottom-nav.png') }}" alt="Horizontal Bottom Nav Layout">
                  </a>
                </div>
              </li>
              <li class="dt-list__item">
                <div class="choose-option">
                  <a href="https://wieldy-html.g-axon.work/horizontal-top-nav" target="_blank" class="choose-option__icon">
                    <img src="{{ asset('/assets/images/layouts/horizontal-top-nav.png') }}" alt="Horizontal Top Nav Layout">
                  </a>
                </div>
              </li>
            </ul>
